                        ...
                        <div class="sparkline13-list">
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <a href="/admin/tambah_pengguna" class="btn btn-success">+ Tambah Pengguna</a>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" >
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="kec">Kecamatan</th>
                                                <th data-field="price">Nip</th>
                                                <th data-field="date">Jabatan</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="datatable-ct"><a href="/admin/lihat_pengguna/{{$pengguna->id}}" class="btn btn-primary">lihat</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
