                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <p>{{$user->kecamatan}}</p>
                                                                    ...
                                                                    <button style="width: 100%" onclick="hapus('{{$user->id}}')" class="btn btn-danger">Hapus Pengguna</button>
                                      </div>
                                      <!-- /col-md-6 -->
                                    </div>
                                    <!-- /row -->
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="all-form-element-inner">
                                                            <form action="/admin/input_edit_pengguna/{{$user->id}}" method="post" enctype="multipart/form-data">
                                                                {{@csrf_field()}}
                                                                {{@method_field('put')}}
                                                                ...
                                                                <div class="form-group-inner">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                            <input name="desa" type="text" class="form-control" value="{{$user->desa}}" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group-inner">
            ...
            <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: left">
                            <p>Apakah Anda ingin menghapus data pengguna ini?</p>
                        </div>
                        <form name="form" action="/admin/hapus_pengguna" method="post">
                            {{csrf_field()}}
                            {{@method_field('delete')}}
