   ...
   <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header" style="margin-top: 10%">
              <p class="centered"><img src="{{Storage::url(auth()->guard('kepala_dinas')->user()->foto)}}" class="img-circle" width="80"></p>
              <h5 class="centered" style="color: red">{{auth()->guard('kepala_dinas')->user()->nama}}</h5>
            </div>
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            @if($notifbaru)
                            <a title="Notifikasi" href="/kepala_dinas/notifikasi" aria-expanded="false"><i class="fa big-icon fa-bell icon-wrap text-danger" aria-hidden="true"></i> <span class="mini-click-non text-danger">Notifikasi</span></a>
                            @else
                        ...
                        <li>
                            <a title="Daftar Proposal Dana" href="/kepala_dinas/daftar_proposal_dana" aria-expanded="false"><i class="fa fa-dollar sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Daftar Proposal Dana</span></a>
                        </li>
                    </ul>
                </nav>
            </div>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                            ...
                                                            <span class="admin-name">{{auth()->guard('kepala_dinas')->user()->nama}}</span>
                                                            <i class="fa fa-angle-down adminpro-icon adminpro-down-arrow"></i>
                                                        </a>
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        <li><a href="/kepala_dinas/profil"><span class="fa fa-user author-log-ic"></span>Profil Saya</a>
                                                        </li>
                                                        <li><a href="/logout_kepala_dinas"><span class="fa fa-lock author-log-ic"></span>Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
