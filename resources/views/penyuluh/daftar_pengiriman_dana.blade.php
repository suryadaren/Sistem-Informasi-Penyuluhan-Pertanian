                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" >
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="tanggal">Tanggal dikirim</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($dana as $d)
                                                @if($d->proposal_dana->draft_programa->user->id == auth()->guard('penyuluh')->id())
                                                    <tr>
                                                        <td>{{$no++}}</td>
                                                        <td>Rp. {{$d->jumlah}},-</td>
                                                        <td>{{$d->created_at->format('Y-m-d')}}</td>
                                                        <td>{{$d->status}}</td>
                                                        <td class="datatable-ct"><a href="/penyuluh/detail_pengiriman_dana/{{$d->id}}" class="btn btn-primary">lihat</a></td>
                                                    </tr>
                                                @endif
                                            @endforeach
                                        </tbody>
