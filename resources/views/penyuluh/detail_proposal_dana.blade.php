                    ...
                    <div class="col-md-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="hpanel email-compose mailbox-view mg-b-15">
                            ...
                            <div class="panel-footer text-right">
                                <div class="btn-group">
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#PrimaryModalhdbgcl"><i class="fa fa-check"></i> Verifikasi Terima Dana</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: left">
                       <h4>Apakah Anda Sudah Menerima uang Penyuluhan ini ?</h4>
                    </div>
                    <div class="modal-footer">
                        <a data-dismiss="modal" href="#">Belum</a>
                        <a href="#">Sudah</a>
                    </div>
                </div>
            </div>
