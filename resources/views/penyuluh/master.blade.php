   ...
   <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header" style="margin-top: 10%">
              <p class="centered"><img src="{{Storage::url(auth()->guard('penyuluh')->user()->foto)}}" class="img-circle" width="80"></p>
              <h5 class="centered" style="color: red">{{auth()->guard('penyuluh')->user()->nama}}</h5>
            </div>
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            @if($notifbaru)
                            <a title="Notifikasi" href="/penyuluh/notifikasi" aria-expanded="false"><i class="fa big-icon fa-bell icon-wrap text-danger" aria-hidden="true"></i> <span class="mini-click-non text-danger">Notifikasi</span></a>
                            @else
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Buat Laporan" href="/penyuluh/pilih_jadwal"><i class="fa fa-apple sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Buat Laporan</span></a></li>
                                <li><a title="Daftar Laporan" href="/penyuluh/daftar_laporan_penyuluhan"><i class="fa fa-apple sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Daftar Laporan</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="fa big-icon fa-desktop icon-wrap"></i> <span class="mini-click-non">Draft Programa</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Buat Draft" href="/penyuluh/buat_draft_programa"><i class="fa fa-apple sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Buat Draft</span></a></li>
                                <!-- <li><a title="Lihat Jadwal" href="/penyuluh/pilih_draft"><i class="fa fa-apple sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Lihat Jadwal</span></a></li> -->
                                <li><a title="Daftar Draft" href="/penyuluh/daftar_draft_programa"><i class="fa fa-apple sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Daftar Draft</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a title="Daftar Surat Tugas" href="/penyuluh/daftar_surat_tugas" aria-expanded="false"><i class="fa fa-briefcase sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Daftar Surat Tugas</span></a>
                        </li>
                        <li>
                            <a title="Daftar Pengiriman Dana" href="/penyuluh/daftar_pengiriman_dana" aria-expanded="false"><i class="fa fa-dollar sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Daftar Pengiriman Dana</span></a>
                        </li>
                        <!-- <li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                            ...
                                                            <span class="admin-name">{{auth()->guard('penyuluh')->user()->nama}}</span>
                                                            <i class="fa fa-angle-down adminpro-icon adminpro-down-arrow"></i>
                                                        </a>
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        <li><a href="/penyuluh/profil"><span class="fa fa-user author-log-ic"></span>Profil Saya</a>
                                                        </li>
                                                        <li><a href="/logout_penyuluh"><span class="fa fa-lock author-log-ic"></span>Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
