                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="index.html">
                                   <i class="fa big-icon fa-dollar icon-wrap"></i>
                        ...
                        <li>
                            <a title="daftar Penyuluh" href="/pegawai_dinas/daftar_penyuluh_lapangan" aria-expanded="false"><i class="fa big-icon fa-users icon-wrap" aria-hidden="true"></i> <span class="mini-click-non">daftar Penyuluh</span></a>
                        </li>
                        <li>
                            <a title="daftar Kepala BPP" href="/pegawai_dinas/daftar_kepala_bpp" aria-expanded="false"><i class="fa big-icon fa-users icon-wrap" aria-hidden="true"></i> <span class="mini-click-non">daftar Kepala BPP</span></a>
                        </li>
                        <li>
                            <a title="daftar Nagari" href="/pegawai_dinas/daftar_nagari" aria-expanded="false"><i class="fa big-icon fa-users icon-wrap" aria-hidden="true"></i> <span class="mini-click-non">daftar Nagari</span></a>
                        </li>
                        <li>
