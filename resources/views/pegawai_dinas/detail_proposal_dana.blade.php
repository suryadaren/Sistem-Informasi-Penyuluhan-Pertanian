                    ...
                    <div class="col-md-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="hpanel email-compose mailbox-view mg-b-15">
                            ...
                            <div class="panel-footer text-right">
                                <div class="btn-group">
                                    @if($proposal->status == "valid oleh kepala dinas")
                                        <a class="btn btn-default" href="/pegawai_dinas/daftar_proposal_dana"><i class="fa fa-arrow-left"></i> Kembali</a>
                                        <a class="btn btn-success" href="/pegawai_dinas/kirim_dana/{{$proposal->id}}"> Verifikasi Kirim Dana <i class="fa fa-arrow-right"></i></a>
                                    @else
                                        <a class="btn btn-default" href="/pegawai_dinas/daftar_proposal_dana"><i class="fa fa-arrow-left"></i> Kembali</a>
                                    @endif
                                </div>
