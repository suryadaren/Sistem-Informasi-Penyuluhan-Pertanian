                    ...
                    <div class="col-md-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="hpanel email-compose mailbox-view mg-b-15">
                            ...
                            <div class="panel-footer text-right">
                                <div class="btn-group">
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#PrimaryModalhdbgcl"><i class="fa fa-upload"></i> Kirim Dana</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: left">
                       <div class="form-group row">
                          <label for="example-number-input" class="col-2 col-form-label">Jumlah Dana Yang Di kirimkan</label>
                          <div class="col-10">
                            <input class="form-control" type="number" value="42" id="example-number-input">
                          </div>
                        </div>
                       <div class="form-group row">
                          <label for="example-number-input" class="col-2 col-form-label">No rekening pengirim</label>
                          <div class="col-10">
                            <input class="form-control" type="text" id="example-number-input">
                          </div>
                        </div>
                       <div class="form-group row">
                          <label for="example-number-input" class="col-2 col-form-label">Nama Pengirim</label>
                          <div class="col-10">
                            <input class="form-control" type="text" id="example-number-input">
                          </div>
                        </div>
                       <div class="form-group row">
                          <label for="example-number-input" class="col-2 col-form-label">Bank</label>
                          <div class="col-10">
                            <input class="form-control" type="text" id="example-number-input">
                          </div>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputFile">Bukti Pengiriman</label>
